      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
            <div className="flex items-center gap-1 text-green-600 min-h-[1.25rem]">
            ...
            <div className={`flex items-center gap-1 min-h-[1.25rem] ${action.budgetChange > 0 ? 'text-green-600' : 'text-red-600'}`}>
